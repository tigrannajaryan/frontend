# This file replaces broken /usr/local/Homebrew/Library/Taps/caskroom/homebrew-versions/Casks/java8.rb,
# see https://github.com/Homebrew/homebrew-cask-versions/pull/6934 for more details.
cask 'java8' do
