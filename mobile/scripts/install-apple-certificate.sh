...
openssl pkcs12 -in mobile/stylist/ios-cert/distribution.p12 -nokeys -passin pass:$IOS_DISTRIBUTION_CERT_PASSWORD | openssl x509 -noout -fingerprint
openssl pkcs12 -in mobile/stylist/ios-cert/distribution.p12 -nokeys -passin pass:$IOS_DISTRIBUTION_CERT_PASSWORD | openssl x509 -noout -subject
...
security import mobile/stylist/ios-cert/distribution.p12 -P $IOS_DISTRIBUTION_CERT_PASSWORD -A -t cert -f pkcs12 -k ios_signing_temp.keychain
