...
security cms -D -i "ios_build/$IOS_SDK/$IOS_APP_NAME.xcarchive/Products/Applications/$IOS_APP_NAME.app/embedded.mobileprovision"
/usr/libexec/PlistBuddy -c "Add provisioningProfiles:$IOS_APP_BUNDLE_ID string made-final-appstore" _XcodeTaskExportOptions.plist
